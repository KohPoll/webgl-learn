(function (window) {
    ...
    var VectMatUtil = {//{{{
        ...
        MatrixState: {
            ...
            modelMatrix: {
                _m: [new Matrix4x3(), new Matrix4x3()],
                _modelStackTop: 0,
                get: function () {
                    return this._m[this._modelStackTop];
                },
                push: function () {
                    ++this._modelStackTop;

                    if (this._modelStackTop == this._m.length) {
                        this._m[this._m.length] = new Matrix4x3();
                    }

                    var top = this._m[this._modelStackTop],
                        parent = this._m[this._modelStackTop - 1];
    ...
    window.VectMatUtil = VectMatUtil;
